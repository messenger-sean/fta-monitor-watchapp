 ...
 */
public class FieldConnectionServiceOld implements ForegroundService {
    ...
    public FieldConnectionServiceOld() {
    }
    ...
    public void startService(Context context, final Intent intent) {
        ...
        Log.d(FieldConnectionServiceOld.class.getName(), "Called startservice");
            ...
            public void run() {
                ...
                m_fieldConnection.error(new ErrorCallback() {
                    ...
                    public void onError(Throwable throwable) {
                        ...
                        Log.w(FieldConnectionServiceOld.class.getName(), "Received signalr error", throwable);
                    }
                });
                ...
                m_fieldConnection.connected(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d(FieldConnectionServiceOld.class.getName(), "Connected to FMS at " + m_url);
                    }
                });
                ...
                try {
                    ...
                    Log.e(FieldConnectionServiceOld.class.getName(), "Error when creating the field monitor connection", e);
                }
            }
        }).start();
    }
